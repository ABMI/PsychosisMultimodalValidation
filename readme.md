...
Introduction
============
This package contains code to externally validate models for the psychosis rehospitalization prediction developed on the multi-modal sources.
...
Technology
==========
  PsychosisMultimodalValidation is an R package.
...
Guide
============
A general guide for running a valdiation study package is available here: [Skeleton Validation Study guide](https://github.com/ABMI/PsychosisMultimodalValidation/inst/doc/UsingSkeletonValidationPackage.pdf)
...
devtools::install_github("ABMI/PsychosisMultimodalValidation")
```
...
===============
  ...
  2. In R, run the code in 'extras/codeToRun.R' (see [Skeleton Validation Study guide](https://github.com/ABMI/PsychosisMultimodalValidation/inst/doc/UsingSkeletonValidationPackage.pdf) for guideance)
...
# Now run the study:
PsychosisMultimodalValidation::execute(connectionDetails = connectionDetails,
...
License
=======
  PsychosisMultimodalValidation is licensed under Apache License 2.0

Development
===========
  PsychosisMultimodalValidation is being developed in R Studio.
